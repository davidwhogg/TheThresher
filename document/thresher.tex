...
We ran both TLI and \TheThresher\ on a stack of 300000 images of a
trinary star system from \LCOGT\@. We show the results using 30, 100, 300,
1000, 3000, 10000, 30000, 100000, and 300000 images stretched to roughly
the same grayscale in all images.

\begin{figure}[!htbp]
    \dfmplot{lucky-trad10.png}
