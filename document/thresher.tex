...
300, 1000, 3000, 10000, 30000 images stretched to roughly the same
...
\begin{figure}[!htbp]
    \dfmplot{tli10000.png}
    \caption{The same as \fig{tli:10} for the top 10000 best images.
            \figlabel{tli:10000}}
\end{figure}

\begin{figure}[!htbp]
    \dfmplot{tli30000.png}
    \caption{The same as \fig{tli:10} for the top 10000 best images.
            \figlabel{tli:30000}}
\end{figure}
